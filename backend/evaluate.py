...
normalized_classes = {
    normalize(class_name): class_name
...
def get_actual_class(filename):
    ...
    mappings = {
        ...
        "cherry": {
            "powderymildew": "Cherry_(including_sour)___Powdery_mildew",
            "healthy": "Cherry_(including_sour)___healthy"
        },

        "corn": {
            "commonrust": "Corn_(maize)___Common_rust_",
            "grayleafspot": "Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot",
            "northernleafblight": "Corn_(maize)___Northern_Leaf_Blight",
        ...
        "grape": {
            ...
            "leafblight": "Grape___Leaf_blight_(Isariopsis_Leaf_Spot)",
            "healthy": "Grape___healthy"
        },

        "orange": {
            "haunglongbing": "Orange___Haunglongbing_(Citrus_greening)"
        },

        "peach": {
            "bacterialspot": "Peach___Bacterial_spot",
            "healthy": "Peach___healthy"
        },

        "pepperbell": {
            "bacterialspot": "Pepper,_bell___Bacterial_spot",
            "healthy": "Pepper,_bell___healthy"
        },

        "potato": {
            "earlyblight": "Potato___Early_blight",
            "lateblight": "Potato___Late_blight",
        ...
        "squash": {
            "powderymildew": "Squash___Powdery_mildew"
        },

        "strawberry": {
            "leafscorch": "Strawberry___Leaf_scorch",
...
for filename in sorted(os.listdir(TEST_DIR)):
    ...
    if actual_class is None:
        print(f"SKIPPED: Could not determine class -> {filename}")
        continue
...
if total == 0:
    print("No valid test images were found.")
    exit()
